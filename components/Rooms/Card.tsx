...
const Card = () => {
    ...
    let [swiperIndex, setSwiperIndex] = useState<number>(1)
  
    let [carouselProgress, setCarouselProgress] = useState<number>(5)
...
<div className="container grid sm:grid-cols-2 lg:grid-cols-3 gap-12 mt-12">
        ...
        >
                ...
                <div className="  h-full w-full  overflow-hidden shadow-lg hover:shadow-xl bg-white rounded-lg ">
