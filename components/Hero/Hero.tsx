 ...
 <div className="py-28 w-screen grid  md:grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-2 bg-white ">
                                ...
                                <div className='mt-20 ml-auto mr-auto w-1/2'>
                                    <div className='flex flex-col'>
                                            ...
                                            <h1 className="relative overflow-visible w-auto mt-0 mr-auto mb-4 pr-2 justify-start items-start text-[#7C6A46] text-5xl text-left capitalize font-semibold  ">Villa Jahawi</h1>
