...
export default function ModalVideo({
  ...
  return (
    <div>
      ...
      {/* Video thumbnail */}
      <button
        className="relative flex justify-between items-center focus:outline-none focus-visible:ring focus-visible:ring-indigo-300 rounded-3xl group"
      ...
      >
        ...
        <svg className="absolute pointer-events-none group-hover:scale-110 transition-transform duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="72" height="72">
          <circle className="fill-blue-600" cx="36" cy="36" r="36" fillOpacity=".8" />
          <path className="fill-white drop-shadow-2xl" d="M44 36a.999.999 0 0 0-.427-.82l-10-7A1 1 0 0 0 32 29V43a.999.999 0 0 0 1.573.82l10-7A.995.995 0 0 0 44 36V36c0 .001 0 .001 0 0Z" />
        </svg>
