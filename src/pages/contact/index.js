...
const Contact = () => {
  ...
  return (
    <>
      <div className={clsx(theme === "dark" ? "bg-[#041434]" : "bg-[#F3F4F6]")}>
        ...
        <section
          className={clsx(" py-20 lg:py-[120px] overflow-hidden relative z-10")}
        >
          <Container>
            <div className="flex flex-wrap -mx-4 lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <h2
                    className={clsx(
                      "mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]",
