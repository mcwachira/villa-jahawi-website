...
export function Workstation() {
  return (
    <section className="overflow-hidden bg-slate-50 py-16 sm:py-24 lg:py-32">
      <Container>
        <div className="grid grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative mx-auto w-full max-w-xl pb-24 lg:mx-0 lg:max-w-none">
            <svg
              ...
              viewBox="0 0 80 79"
              fill="none"
              className="absolute left-0 top-8 scale-75 sm:top-11 sm:-left-4 sm:scale-100"
            >
