      ...
      <div className="flex flex-col lg:flex-row mx-auto w-full px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        <Container>
          ...
          <div className="w-full">
            <div className=" ml-auto w-full mt-16 grid aut-cols-max auto-rows-max grid-cols-1 gap-4 border-t border-gray-100 pt-16 lg:grid-cols-2 md:gap-20 ">
              ...
              <div className="ml-auto w-full   mt-8 md:mt-0 grid grid-cols-1 gap-4  md:grid-cols-4 md:gap-16 lg:grid-cols-4">
                <div className="text-2xl w-full text-center sm:text-left">
                  <h2 className="text-3xl font-semibold ">About Us</h2>

                  <ul className="mt-8 text-xl space-y-4">
                    <li>
                      <Link
