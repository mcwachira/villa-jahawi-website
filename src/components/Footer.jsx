    ...
    >
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="w-full">
          <div className=" w-1/2 mt-16 grid grid-cols-1 gap-3 border-t border-gray-100 pt-16 md:grid-cols-2 md:gap-16 ">
            ...
            <div className="ml-auto w-full mt-8 md:mt-0 grid grid-cols-1 gap-2  md:grid-cols-6 md:gap-16 lg:grid-cols-6">
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium ">Gallery</p>
                ...
                <div className="mx-auto mt-8 max-w-md sm:ms-0">
                  ...
                  <form className="mt-4">
                    <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                      ...
                      <button
                        className="block rounded-full bg-[#4a576e] px-8 py-3 font-medium text-white transition "
                        type="submit"
                      >
                        Subscribe
                      </button>
