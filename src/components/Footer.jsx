...
const Footer = () => {
  ...
  return (
<footer className={clsx('overflow-hidden bg-slate-900 pb-8 pt-20 sm:pb-12 sm:pt-24 lg:pt-32',theme==='light'? '!bg-[#F3F4F6]':'!bg-[#1D1E30]')}>
 ...
 <Image
   ...
   alt=""
   width={80} height={80} 
   className="h-18 w-auto sm:h-20  lg:h-20 dark:hidden"
 />):( <Image
                 src={colorLogo}
                 alt=""
                 width={80} height={80} 
        ...
        <div className="mx-auto mt-8 max-w-md sm:ms-0">
          ...
          <form className="mt-4">
            ...
            >
              ...
              <button
                className="block rounded-full bg-[#7c6a46] px-8 py-3 font-medium text-white transition "
                type="submit"
              >
                Subscribe
              </button>
